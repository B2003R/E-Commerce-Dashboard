"""
SQL Constraint Execution Script
...
class SQLScriptExecutor:
    """Execute SQL scripts with connection management"""
    ...
    def connect(self):
        ...
        try:
            ...
            logger.info(f"Schema set to: {self.schema}")
    ...
    def execute_sql_script(self, sql_file_path):
        ...
        try:
            ...
            # Better parsing to handle multi-line statements
...
def main():
    ...
    try:
        logger.info("=" * 80)
        logger.info("Starting SQL Constraint Script Execution")
        logger.info("=" * 80)
        ...
        # Execute SQL script
        executor.execute_sql_script(sql_file)
        
        logger.info("=" * 80)
        logger.info("Constraint creation process completed")
        logger.info("=" * 80)
